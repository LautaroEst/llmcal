...
mkdir -p experiments/dbpedia_128_131/basic_dbpedia_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions
ln -sf ../../../../../../dbpedia_4_926/basic_dbpedia_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions/test experiments/dbpedia_128_131/basic_dbpedia_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions
python -m llmcal dbpedia_128_131 basic_dbpedia_0-shot_litgpt lm_phi3 no_adaptation_bf16 no_calibration --accelerator "gpu" --batch_size 1
...
python -m llmcal dbpedia_128_131 basic_dbpedia_0-shot_litgpt lm_phi3 no_adaptation_bf16 affine_scalar \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
...
python -m llmcal dbpedia_128_131 basic_dbpedia_0-shot_litgpt lm_phi3 no_adaptation_bf16 temp_scaling \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
...
python -m llmcal dbpedia_128_131 basic_dbpedia_0-shot_litgpt lm_phi3 no_adaptation_bf16 bias_only \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
