...
mkdir -p experiments/20newsgroups_128_129/basic_20newsgroups_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions
ln -sf ../../../../../../20newsgroups_4_295/basic_20newsgroups_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions/test experiments/20newsgroups_128_129/basic_20newsgroups_0-shot_litgpt/lm_phi3/no_adaptation_bf16/.cache/predictions
python -m llmcal 20newsgroups_128_129 basic_20newsgroups_0-shot_litgpt lm_phi3 no_adaptation_bf16 no_calibration --accelerator "gpu" --batch_size 1
...
python -m llmcal 20newsgroups_128_129 basic_20newsgroups_0-shot_litgpt lm_phi3 no_adaptation_bf16 affine_scalar \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
...
python -m llmcal 20newsgroups_128_129 basic_20newsgroups_0-shot_litgpt lm_phi3 no_adaptation_bf16 temp_scaling \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
...
python -m llmcal 20newsgroups_128_129 basic_20newsgroups_0-shot_litgpt lm_phi3 no_adaptation_bf16 bias_only \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
