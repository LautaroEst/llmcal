...
mkdir -p experiments/20newsgroups_small/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration/
ln -sf ../../../../../20newsgroups_large/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration/predictions \
    experiments/20newsgroups_small/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration

mkdir -p experiments/20newsgroups_medium/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration/
ln -sf ../../../../../20newsgroups_large/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration/predictions \
    experiments/20newsgroups_medium/basic_20newsgroups_0-shot_litgpt/lm_tinyllama/no_adaptation_bf16/no_calibration
