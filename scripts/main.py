    ...
    **mods,
    ...
    if task == "language_model" and model_type == "litgpt" and method == "full_ft":
        ...
        model_init_args = dict(
            checkpoint_dir = model_config["checkpoint_dir"],
            embedding_pooling = model_config["embedding_pooling"],
            use_lora_checkpoint = method_config["use_lora_checkpoint"],
            lora_r = method_config["lora_r"],
            lora_alpha = method_config["lora_alpha"],
            lora_dropout = method_config["lora_dropout"],
            lora_query = method_config["lora_query"],
            lora_key = method_config["lora_key"],
            lora_value = method_config["lora_value"],
            lora_projection = method_config["lora_projection"],
            lora_mlp = method_config["lora_mlp"],
            lora_head = method_config["lora_head"],
            loss_fn = method_config["loss_fn"],
            optimizer = method_config["optimizer"],
            learning_rate = method_config["learning_rate"],
            weight_decay = method_config["weight_decay"],
