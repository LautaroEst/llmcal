...
for suffix in 8_639 8_923 8_932 8_6391 8_9322; do
    for method in mahalanobis ; do
        python -m llmcal ${dataset}_${suffix} basic_${dataset}_0-shot_litgpt lm_phi3 no_adaptation_bf16 $method --accelerator "gpu" --batch_size 1 --calibration.max_ls 40 --calibration.learning_rate 1e-2 --calibration.accelerator "cpu" --calibration.max_epochs 30
    done
done
