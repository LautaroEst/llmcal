...
python -m llmcal agnews_16_738 basic_agnews_0-shot_litgpt lm_llama3 no_adaptation_bf16 no_calibration --accelerator "gpu" --batch_size 1

mkdir -p experiments/agnews_256_493/basic_agnews_0-shot_litgpt/lm_llama3/no_adaptation_bf16/.cache/predictions
...
python -m llmcal agnews_4_295 basic_agnews_0-shot_litgpt lm_llama3 no_adaptation_bf16 no_calibration --accelerator "gpu" --batch_size 1


### No adaptation + affine scalar
python -m llmcal agnews_4_295 basic_agnews_0-shot_litgpt lm_llama3 no_adaptation_bf16 affine_scalar \
    --accelerator "gpu" \
    --batch_size 1 \
...
python -m llmcal agnews_4_295 basic_agnews_0-shot_litgpt lm_llama3 no_adaptation_bf16 temp_scaling \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
...
python -m llmcal agnews_4_295 basic_agnews_0-shot_litgpt lm_llama3 no_adaptation_bf16 bias_only \
    --accelerator "gpu" \
    --batch_size 1 \
    --calibration.max_ls 40 \
    --calibration.learning_rate 1e-2 \
