...
def load_dataset(dataset_name, data_dir, num_train_samples, num_val_samples, num_shots, random_state = 0):
    load_fn = dataset2load_fn[dataset_name]
    train_datadict = load_fn(data_dir)
    ...
    predict_datadict = load_fn(data_dir) # original dataset
